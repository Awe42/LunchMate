 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $e=e=>t=>typeof t=="function"?((r,n)=>(customElements.define(r,n),n))(e,t):((r,n)=>{const{kind:o,elements:i}=n;return{kind:o,elements:i,finisher(s){customElements.define(r,s)}}})(e,t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Wo=` ${U} `;class sn{constructor(t,r,n,o){this.strings=t,this.values=r,this.type=n,this.processor=o}getHTML(){const t=this.strings.length-1;let r="",n=!1;for(let o=0;o<t;o++){const i=this.strings[o],s=i.lastIndexOf("<!--");n=(s>-1||n)&&i.indexOf("-->",s+1)===-1;const d=he.exec(i);r+=d===null?i+(n?Wo:rn):i.substr(0,d.index)+d[1]+d[2]+"$lit$"+d[3]+U}return r+=this.strings[t],r}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Zo=new class{handleAttributeExpressions(e,t,r,n){const o=t[0];return o==="."?new Ko(e,t.slice(1),r).parts:o==="@"?[new Go(e,t.slice(1),n.eventContext)]:o==="?"?[new qo(e,t.slice(1),r)]:new ln(e,t,r).parts}handleTextExpression(e){return new jt(e)}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ve=class extends Et{constructor(){super(...arguments);this.hasSlotController=new $n(this,"footer","header","image")}render(){return Pe`
      <div
        part="base"
...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Tn=(e,t,r,n)=>{for(var o=n>1?void 0:n?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Fi(t,r,o),o};let _e=class extends V{constructor(){super();this.message="Welcome!"}static get styles(){return[zi,Ht`
      #welcomeBar {
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return mt`
      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-button href="${"/LunchMate/"}about" variant="primary">Navigate to About</sl-button>
        </div>
    ...
    `}render(){return mt`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?mt`<sl-button href="${"/LunchMate/"}">
            Back
          </sl-button>`:null}
    ...
    `}};Ne([Se({type:String})],Dt.prototype,"title",2);Ne([Se({type:Boolean})],Dt.prototype,"enableBack",2);Dt=Ne([$e("app-header")],Dt);var Ji=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,Yi=(e,t,r,n)=>{for(var o=n>1?void 0:n?Gi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Ji(t,r,o),o};let Dr=class extends V{static get styles(){return Ht`
      main {
        padding-left: 16px;
        padding-right: 16px;
        padding-bottom: 16px;
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/LunchMate/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.277de69a.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.fa9bb6d0.js.map
